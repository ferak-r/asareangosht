...
class ManagementController extends Controller
{
    private const RESOURCES = [
        ...
        'tasks' => ['model'=>Task::class,'title'=>'تسک‌ها','roles'=>['admin','employee','project_manager','department_manager'],'fields'=>['project_subitem_id','title','assignee_ids','description','status','priority','progress_percent','planned_start_date','planned_end_date','estimated_days','due_date','return_reason']],
    ];
